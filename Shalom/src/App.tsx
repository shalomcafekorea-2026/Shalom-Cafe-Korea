...
/* ============================================================
   ...
   ============================================================ */
const galleryImages = [
  { src: "/images/hero-bibimbap.jpg", alt: "Hot Stone Bibimbap", label: "Hot Stone Bibimbap" },
  { src: "/images/samgyeopsal.jpg", alt: "Samgyeopsal Grill", label: "Samgyeopsal" },
  { src: "/images/korean-chicken.jpg", alt: "Korean Fried Chicken", label: "Korean Fried Chicken" },
  { src: "/images/ramyun.jpg", alt: "Ramyun", label: "Ramyun" },
  { src: "/images/kimbap.jpg", alt: "Kimbap", label: "Kimbap" },
  { src: "/images/bingsu-coffee.jpg", alt: "Mango Bingsu & Coffee", label: "Bingsu & Coffee" },
];
...
function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <img
          src="/images/hero-korean-feast.jpg"
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="rv img-zoom rounded-2xl overflow-hidden shadow-2xl shadow-stone-300/30 order-2 lg:order-1">
            <img
              ...
              alt="Shalom Cafe Korea Interior"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          {galleryImages.map((img, i) => (
            <div
              key={img.src}
              className={`rv img-zoom rounded-2xl overflow-hidden shadow-lg shadow-stone-200/50 ${
                i === 0 || i === 5 ? "row-span-2" : ""
              }`}
